...
"""#### Running the BLSTM model for 1 user."""

execute1('blstm',users,1)

"""#### Running the Random Forest model for 1 user."""

execute1('random forest',users,1)

"""#### Running the BLSTM model for all the users."""

execute1('blstm',users,len(users.keys()))

"""#### Running the Random Forest model for all the users."""
